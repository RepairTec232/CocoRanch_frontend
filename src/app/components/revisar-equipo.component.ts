...
export class RevisarEquipoComponent implements OnInit {
  ...
  listaEstatus: string[] = ['RECIBIDO', 'EN_REVISION', 'ESPERANDO_REPUESTO', 'REPARADO', 'ENTREGADO'];
...
guardarCambios() {
  ...
  this.reparacionesService.actualizarOrden(this.ordenId, datosModificados).subscribe({
    next: () => {
